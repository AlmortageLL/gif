...
chsource = Redis:get(Fast..'chsource') or "AlmortagelTech"
devsource = Redis:get(Fast..'devsource') or "Almortagel_12"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,5089553588,5969871722,627658332,5986905034,6430417482,55555555555,5555555555}
...
elseif UserId == 6430417482 then
Status = 'مطـور السـورس '
elseif UserId == 6763929415 then
Status = ' ستك ملوكة يقلب امك ❤️‍🔥 '
elseif UserId == 627658332 then
Status = 'مطـور السـورس '
elseif UserId == Sudo_Id then  
...
xname =  (Redis:get(Fast.."Name:Bot") or "[المرتجل]") 
...
if tonumber(senderr) == 5089553588 then
msg.Name_Controller = 'المبرمج المرتجل ❤️‍🔥  '
...
if msg.sender_id.user_id == tonumber(5089553588) then
send(msg_chat_id,msg_id,"مرحبآ بك عزيزي المبرمج المرتجل نورت الجروب - 🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(6430417482) then
send(msg_chat_id,msg_id,"آهلا بيك عزيزتي المبرمجه لولا ملكه السورس ❤️‍🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(5986905034) then
send(msg_chat_id,msg_id,"آهلا بيك عزيزتي المبرمجه لولا ملكه السورس ❤️‍🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
...
if idephoto then
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "[المرتجل]")
...
local name_parlo = bot.getUser(5089553588).first_name.." "..bot.getUser(5089553588).last_name
local caption = "اليك قائمه مطورين سورس المرتجل :"
if tonumber(UserId_Info.id) ~= 5089553588 then
...
{
{text = name_parlo, data = msg.sender_id.user_id..'/DevShow@5089553588'},
},
LocalDev
,
{
...
return send(msg.chat_id, msg.id,"الرابط خطأ \nارسل الرابط بالشكل ده كمثال : https://t.me/AlmortagelTech ", 'md', true)
end
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(5089553588) then
...
if text == 'لولا' or text == 'مرات الالمرتجل' then
...
{
{text = '‹ MRAET ALMORTAGEL › .', url = "https://t.me/merat_caser"}
},
{
{text = ' ⛥ALMORTAGEL⛥ ', url = "https://t.me/Almortagel_12"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'المرتجل' or text == 'المبرمج المرتجل' then
photo = "https://t.me/Almortagel_12"
local T =[[
[ٓ  ᯓ 𓆩 ˹ †ø δølløω ძενεløρεƦ øδ †hε ՏøuƦcε ˼ 𓆪 𓆃](t.me/Almortagel_12 )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '‹ ٰ𖣂 • BOT ALMORTAGEL • 𖣂 ›', url = "https://t.me/caserbotbot"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
photo = "https://t.me/AlmortagelTech"
local T =[[
— — — — — — — — —— — — 
...
bot.sendText(Sudo_Id,0,'*\n●  مرحباً عزيزي المطور \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِѕᴏụʀᴄᴇ ᴀʟᴍᴏʀᴛᴀɢᴇʟ,━━━━⩺ \n●  اسمه :- '..klajq..' \n●  ايديه :-  : '..msg.sender_id.user_id..'\n●  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'المبرمج' or text == 'المرتجل' or text  == 'المبرمج المرتجل' then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
bot.sendText(5089553588,0,'*\n◉  مرحباً عزيزي المبرمج المرتجل \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِѕᴏụʀᴄᴇ ᴀʟᴍᴏʀᴛᴀɢᴇʟ,━━━━⩺ \n◉  اسمه :- '..klajq..' \n◉  ايديه :-  : '..msg.sender_id.user_id..'\n◉  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'فوفا' or text == 'فراولا'  then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
...
bot.sendText(5986905034,0,'*\n◉  مرحباً عزيزتي لولا قلب الالمرتجل هناك \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِѕᴏụʀᴄᴇ ᴀʟᴍᴏʀᴛᴀɢᴇʟ━━━━⩺ \n◉  اسمه :- '..klajq..' \n◉  ايديه :-  : '..msg.sender_id.user_id..'\n◉  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == "صورتي" then
...
if msg.sender_id.user_id == tonumber(5089553588) then
send(msg_chat_id,msg_id,"❍ انت المرتجل مطور السورس يقلبي🌚♥","md",true)
...
send(msg_chat_id,msg_id,"انتي [لولا مرات المرتجل] يقلبي 🥺♥","md",true)
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(5089553588) then
local txx = "\n"
...
return send(msg_chat_id,msg_id,'\n⌯ مرحبا بك في السجل المدني الخاص بسورس ALMORTAGEL\nاكتب اسمك الان :',"md",true)  
end
...
keyboard.inline_keyboard = {
{
{text = 'قناة السورس',url="t.me/AlmortagelTech"}
},
}
local msg_id = msg.id/2097152/0.5
...
keyboardd.inline_keyboard = {
{
{text = 'قناة السورس', url = "https://t.me/AlmortagelTech"}
},
}
local msg_id = msg.id/2097152/0.5
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@AlmortagelTech")
sleep(1)
...
if text == (Redis:get(Fast.."Name:Bot") or "المرتجل") then
local photo = bot.getUserProfilePhotos(Fast)
if photo.total_count > 0 then
local NamesBot = (Redis:get(Fast.."Name:Bot") or "المرتجل")
local Mostafa = {
'• مالك حبيبى 🥺',
...
if text == 'المرتجل' or text == 'مبرمج السورس' or text == 'Almortagel' then  
local UserId_Info = bot.searchPublicChat("Almortagel_12")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ 𝘋𝘌𝘝 ALMORTAGEL ❳\n— — — — — — — — —\n ⌔︙*َժٍᥱُ᥎ ٍَꪀَٰᥲ️ِّّꪔٍᥱ≋* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n⌔︙*َժٍᥱُ᥎ ٍႦᎥُِ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '◈ ℻ᗪEᐯ • ALMORTAGEL℻ ◈', url = "https://t.me/Almortagel_12"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = '❲ المبرمج المرتجل ❳', url = "https://t.me/Almortagel_12"}
},
{
{text = 'ѕᴏụʀᴄᴇ ᴀʟᴍᴏʀᴛᴀɢᴇʟ', url = "https://t.me/AlmortagelTech"},
},
...
data = {
{
{text = '𓆩 ˹ [ѕᴏụʀᴄᴇ ᴀʟᴍᴏʀᴛᴀɢᴇʟ] ˼ 𓆪', url = "https://t.me/AlmortagelTech"}
},
}
}
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
[ٓ ˚₊· ͟͟͞͞➳❥❬ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 [𝙲𝙷] ѕᴏụʀᴄᴇ ᴀʟᴍᴏʀᴛᴀɢᴇʟ ❭• °](t.me/AlmortagelTech )
]],"md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup)
end
if text == '/start' then
...
local Name_dev = bot.getUser(Sudo_Id).first_name
local UName_dev = bot.getUser(Sudo_Id).username
local CmdStart = '*\n🤖╖ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "[المرتجل]")..
'\n🎧╢• لأستخدام البوت اغاني وفيديو كول '..
'\n🎥╢• اكتب » /music ثم أضغط الأوامر .'..
'\n🕹╢اكتب /Almortagel لاظهار كيبورد الاعضاء '..
...
'\n📣╢• ــــــــــــــــــــѕᴏụʀᴄᴇ ᴀʟᴍᴏʀᴛᴀɢᴇʟــــــــــــــــ '..
'\n📣╢• تأكد » من تفعيل الرفع '..
